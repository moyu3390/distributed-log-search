...
import com.hclteam.distributed.log.core.snowworker.core.OverCostActionArg;
 ...
 */
public class DriftSnowWorker implements ISnowWorker {
     ...
     * @param options
     */
    public DriftSnowWorker(IdGeneratorOptions options) {
